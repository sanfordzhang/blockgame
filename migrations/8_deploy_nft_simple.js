const AchievementNFTSimple = artifacts.require("AchievementNFTSimple");
...
module.exports = async function(deployer, network) {
  const privateKey = network === 'mainnet'
    ...
    : process.env.NILE_PRIVATE_KEY || process.env.TESTNET_PRIVATE_KEY;
  ...
  console.log(`Deploying AchievementNFTSimple to ${network}...`);
  console.log(`Signer address: ${signerAddress}`);
  console.log(`Base URI: ${baseURI}`);

  await deployer.deploy(AchievementNFTSimple, signerAddress, baseURI);

  const instance = await AchievementNFTSimple.deployed();
  console.log(`AchievementNFTSimple deployed at: ${instance.address}`);
  ...
  console.log(`NFT_CONTRACT_ADDRESS=${instance.address}`);
  console.log('==============================================\n');
};
